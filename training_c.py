...
from agent_c_S import continuous_Conceptual_Agent
from policy_nets import multitask_softmax_policy_Net
...
if __name__ == "__main__":    
    ...
    parser.add_argument("--latent_dim", default=DEFAULT_LATENT_DIM, help="Dimensionality of hidden feedforward layers, default=" + str(DEFAULT_LATENT_DIM))
    parser.add_argument("--code_dim", default=DEFAULT_CODE_DIM, help="Dimensionality of continuous concept, default=" + str(DEFAULT_CODE_DIM))
    ...
    conceptual_agent = continuous_Conceptual_Agent(args.inner_state_dim, args.vision_latent_dim, args.code_dim, args.latent_dim, args.noisy, args.lr).to(device)
    conceptual_policy = multitask_softmax_policy_Net(args.code_dim, args.n_actions, args.n_tasks, args.lr)
